    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/WebStudy/AdminController/main">Classes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/WebStudy/AdminController/getAllUserView">Users</a>
                </li>
                <li class="nav-item">
        ...
        <a href="http://localhost/WebStudy/AdminController/getFormAddClass"
            class="btn bg_bt_add btn-outline-light me-4 text-dark">New Class</a>

        <a href="http://localhost/WebStudy/AdminController/getViewAddNewAdmin"
            class="btn btn-success btn-outline-light me-4">New Admin</a>
